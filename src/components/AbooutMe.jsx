        ...
        <div className='md:w-4/5 md:pb-40 pb-10 px-4 md:px-0 mx-auto bg-[#282C33]'>
            ...
            <div className='flex gap-5 items-center'>
                <div className='flex flex-nowrap'>
                    <h1 className='text-2xl md:text-3xl font-medium flex flex-nowrap'><span className='text-[#C778DD]'>#</span>about-me</h1>
                </div>
            ...
            <div className='mt-10 flex flex-col md:flex-row items-center justify-between gap-10'>
                <div className='space-y-8 max-w-lg'>
                    <p className='font-[16px] text-[#ABB2BF]'>I'm Chandan Karmaker</p>

                    <p className='font-[16px] text-[#ABB2BF]'>
